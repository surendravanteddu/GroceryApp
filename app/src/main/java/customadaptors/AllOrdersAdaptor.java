...
public class AllOrdersAdaptor extends BaseAdapter{
    ...
    public AllOrdersAdaptor(){

    }

    public AllOrdersAdaptor(Context context,List<Map<String,String>> list){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(viewHolder==null) {
            ...
            convertView = layoutInflater.inflate(R.layout.all_orders_list,null);
    ...
    public void showText(int position,View v){
        Intent i = new Intent(v.getContext(), OrderItem.class);
