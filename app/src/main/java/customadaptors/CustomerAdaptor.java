...
public class CustomerAdaptor extends BaseAdapter {
    ...
    public CustomerAdaptor(Context context, List<Map<String,String>> list){
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(viewHolder==null) {
            ...
            convertView = layoutInflater.inflate(R.layout.customer_list,null);
            viewHolder.username = (TextView) convertView.findViewById(R.id.username);
            viewHolder.firstname = (TextView) convertView.findViewById(R.id.firstname);
            viewHolder.deleteFromCustomer = (Button) convertView.findViewById(R.id.deleteFromCustomer);
        ...
        viewHolder.deleteFromCustomer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                deleteFromCustomer(position);
            }
        });
        return convertView;
    }
    ...
    public void deleteFromCustomer(int position){
        aus = new AppUserService();
        String msg="";
        if(aus.deleteFromCustomer(list.get(position).get("username")).equalsIgnoreCase("deleted")){
